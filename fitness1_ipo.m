function [Fitness] = fitness1_ipo(VV)
% Ali Mohammadi_INS/GNSS
Rsiz1   = size(VV,1)      ;
Fitness = zeros(Rsiz1, 1) ;
...
Sum1 = print_rmse (nav1_r, gnss_r, ref_1, ref_g, 'ADIS16405 INS/GNSS');
% ---------------------------------------------------------------------

%% Print RMSE from IMU2
% ---------------------------------------------------------------------
Sum2 = print_rmse (nav2_r, gnss_r, ref_2, ref_g, 'ADIS16488 INS/GNSS');
...
% ---------------------------------------------------------------------
Fitness(r) = sum(Sum1(1:9)+Sum2(1:9))/2;
end
% ---------------------------------------------------------------------
