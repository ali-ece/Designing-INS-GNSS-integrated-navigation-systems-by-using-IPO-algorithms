function [nav_e] = ins_gnss1(imu, gnss, att_mode)
...
imu.VV;
VVV(1) = imu.VV(1); VVV(2) = imu.VV(2); VVV(3) = imu.VV(3);...
VVV(4) = imu.VV(4); VVV(5) = imu.VV(5); VVV(6) = imu.VV(6);...
VVV(7) = imu.VV(7); VVV(8) = imu.VV(8); VVV(9) = imu.VV(9);...
VVV(10) = imu.VV(10); VVV(11) = imu.VV(11); VVV(12) = imu.VV(12);...
VVV(13) = imu.VV(13); VVV(14) = imu.VV(14); VVV(15) = imu.VV(15);...
VVV(16) = imu.VV(16); VVV(17) = imu.VV(17); VVV(18) = imu.VV(18);
VVV;
kf.R  = diag(VVV(1:6));
kf.Q  = diag(VVV(7:18));
%-------------------------------------------------------------------------
